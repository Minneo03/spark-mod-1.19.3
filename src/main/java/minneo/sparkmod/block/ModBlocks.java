...
public class ModBlocks {
    ...
    public static final Block WHITE_PHOSPHORUS_WOOD = registerBlock("white_phosphorus_wood", new PillarBlock(FabricBlockSettings.copyOf(Blocks.OAK_WOOD).strength(5.0f).requiresTool()),ModItemGroup.SPARK);
    public static final Block STRIPPED_WHITE_PHOSPHORUS_LOG = registerBlock("stripped_white_phosphorus_log", new PillarBlock(FabricBlockSettings.copyOf(Blocks.STRIPPED_OAK_LOG).strength(5.0f).requiresTool()),ModItemGroup.SPARK);
    public static final Block STRIPPED_WHITE_PHOSPHORUS_WOOD = registerBlock("stripped_white_phosphorus_wood", new PillarBlock(FabricBlockSettings.copyOf(Blocks.STRIPPED_OAK_WOOD).strength(5.0f).requiresTool()),ModItemGroup.SPARK);

    public static final Block WHITE_PHOSPHORUS_PLANKS = registerBlock("white_phosphorus_planks", new Block(FabricBlockSettings.copyOf(Blocks.OAK_PLANKS).strength(5.0f).requiresTool()),ModItemGroup.SPARK);
    public static final Block WHITE_PHOSPHORUS_LEAVES = registerBlock("white_phosphorus_leaves", new LeavesBlock(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).strength(0.5f)),ModItemGroup.SPARK);

    public static final Block WHITE_PHOSPHORUS_SAPLING = registerBlock("white_phosphorus_sapling", new SaplingBlock(new WhitePhosphorusSaplingGenerator(),FabricBlockSettings.copyOf(Blocks.OAK_SAPLING).strength(0.5f)),ModItemGroup.SPARK);
     ...
     * @param group - The item group of the block.
